...
impl std::ops::Neg for CheckedF64 {
    ...
    /// # Returns
    ///
    /// Returns a new `CheckedF64` instance with the negated value.
    ///
    /// # Example
    ///
    /// ```rust
...
mod tests {
    ...
    proptest! {
        ...
        fn test_negation(a in valid_f64()) {
            ...
            prop_assert_eq!(negated.get(), Ok(-a));
        }
        ...
        fn test_negation_invalid(a in invalid_f64()) {
            let checked_a = CheckedF64(a);
            let negated = -checked_a;
            prop_assert_eq!(negated.get(), Err(FloatError));
        }
        ...
        fn test_valid_cmp_valid(a in valid_f64(), b in valid_f64()) {
            ...
            prop_assert_eq!(CheckedF64(a) > b, a > b);
            prop_assert_eq!(a > CheckedF64(b), a > b);
            prop_assert_eq!(CheckedF64(a) >= CheckedF64(b), a >= b);
            prop_assert_eq!(CheckedF64(a) < CheckedF64(b), a < b);
            prop_assert_eq!(CheckedF64(a) <= CheckedF64(b), a <= b);
